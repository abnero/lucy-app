        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border-radius:16px; border:1px solid #E8E6F4; padding:40px;">
          ...
          <tr>
            <td style="padding-bottom:28px;">
              <p style="margin:0; font-size:14px; color:#9896B0; line-height:1.6;">Tu acceso a Lucy está listo. Ya puedes entrar y crear tu calendario metabólico personalizado.</p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding-bottom:32px;">
              <a href="https://www.lucy.fit/login" style="display:inline-block; background-color:#7B7FC4; color:#FFFFFF; text-decoration:none; font-size:14px; font-weight:500; padding:12px 32px; border-radius:12px;">Entrar a Lucy</a>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center">
              <p style="margin:0; font-size:11px; color:#9896B0;">El equipo de Lucy 💜</p>
              <p style="margin:4px 0 0; font-size:10px; color:#B8B5E0;">Powered by Caribeño Fit Labs</p>
            </td>
          </tr>
        </table>
      </td>
