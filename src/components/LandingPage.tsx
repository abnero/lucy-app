    ...
    <div style={{ color: '#2D2B45', lineHeight: 1.6, fontSize: 18 }}>
            ...
            <div>
              ...
              <div style={{ background: '#FFF', border: '2px solid #7B7FC4', padding: 32, borderRadius: 16, margin: '32px 0', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, textAlign: 'center' }} className="origin-stat-grid">
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', color: '#555', marginTop: 8 }}>Libras que perdieron en promedio</div>
                </div>
                <div>
        ...
        <div style={container}>
          ...
          <div style={{ background: '#FFF', borderRadius: 16, padding: 40, marginBottom: 30, display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 40, alignItems: 'center' }} className="landing-bonus-card">
            <div style={{
              ...
              <img
                src="/curso-online-bono.png"
                alt="Curso de Activación Metabólica por Coach Abner"
                style={{
                  maxWidth: '100%',
                  width: 'auto',
                  maxHeight: 500,
            ...
            <div>
              <span style={{ display: 'inline-block', background: '#7B7FC4', color: '#FFF', padding: '6px 16px', borderRadius: 6, fontSize: 14, fontWeight: 700, marginBottom: 12 }}>Valor: $299 — Hoy GRATIS</span>
              <h3 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Curso: Activación Metabólica</h3>
              <p style={{ fontSize: 14, color: '#7B7FC4', fontWeight: 600, marginBottom: 12 }}>Las 5 Áreas Fundamentales del Fitness</p>
              <div style={{ fontSize: 15, color: '#2D2B45', lineHeight: 1.6 }}>
                <p style={{ marginBottom: 12, fontWeight: 600 }}>
                  El curso completo que enseño a mis clientas privadas — ahora incluido cuando compras Lucy.
                </p>
                <p style={{ marginBottom: 12 }}>
                ...
                <div style={{ marginTop: 14, padding: '12px 16px', background: '#F8F7FC', borderLeft: '3px solid #7B7FC4', borderRadius: 4 }}>
                  ...
                  <div style={{ fontSize: 13, color: '#2D2B45', opacity: 0.85 }}>
                    Acceso inmediato post-compra. Velo a tu ritmo cuando estés lista para profundizar.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div style={narrow}>
          <div style={{ background: '#2D2B45', borderRadius: 16, padding: '32px 24px', color: '#FFFFFF', maxWidth: 500, margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 12, marginBottom: 14, paddingBottom: 12, borderBottom: '1px dotted rgba(255,255,255,0.2)' }}>
                <span style={{ flex: 1, fontSize: 15, lineHeight: 1.4 }}>🎁 Curso de Activación Metabólica (54 módulos)</span>
      ...
      <section style={{ background: '#FFF', padding: '100px 0', textAlign: 'center' }} className="landing-section">
        <div style={narrow}>
          ...
          <div style={{ maxWidth: 600, margin: '0 auto 40px', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              <span style={{ fontSize: 20, flexShrink: 0 }}>✅</span>
              <span style={{ fontSize: 16, color: '#2D2B45', lineHeight: 1.5 }}>Curso de Activación Metabólica — 54 módulos en video <span style={{ opacity: 0.7, fontSize: 14 }}>($299)</span></span>
            </div>
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              <span style={{ fontSize: 20, flexShrink: 0 }}>✅</span>
      ...
      <section style={{ background: '#F8F7FC', padding: '100px 0' }} className="landing-section">
        <div style={narrow}>
          ...
          <FaqItem question="¿Qué pasa después del año?" answer="Tu acceso a Lucy expira al cumplirse el año. Si quieres seguir usándola, renuevas tú misma — <strong>no hay cobros automáticos.</strong> Tú decides si renuevas o no. Este es el diferencial más grande vs otras apps que te meten en suscripción que renueva para siempre." />
